...
def parse_args(input_args=None):
    ...
    parser.add_argument("--data_type", type=str, choices=["single", "two_object", "relational"], help="Type of data to train on.")
    parser.add_argument("--folder_path", type=str, help="Path to folder containing training images.")
    ...
    if args.data_type == "single":
        for folder in os.listdir(args.folder_path):
            concepts_list.append(
                {
                    "instance_prompt":      "photo of a " + folder,
                    "instance_data_dir":    args.folder_path + "/" + folder,
                    "class_prompt":         "",
                    "class_data_dir":       ""
                })
